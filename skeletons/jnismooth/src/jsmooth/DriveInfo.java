...
public class DriveInfo {
	...
	/**
	 * Return the free space of the volume available to the user. This value can
	 * be different from getFreeSpace() when the filesystem implements quotas.
	 * 
	...
	/**
	 * Return the total space of the volume, including the free and allocated
	 * space.
	 * 
	...
	/**
	 * Return the serial number of the volume, as allocated by the system during
	 * the formatting of the volume.
	 * 
	...
	/**
	 * The maximum size supported by the file system for a single component
	...
	/**
	 * If a name has been defined for the volume represented by this object, it
	...
	public String toString() {
		...
		res += ":" + m_freeBytesForUser + ":" + m_totalFreeBytes + "/"
				+ m_totalBytes;
		res += "," + m_serialNumber + "," + m_maxComponentSize + ","
				+ m_systemFlags + "," + m_volumeName + "," + m_fileSystemName;
		res += "]";
		return res;
	}

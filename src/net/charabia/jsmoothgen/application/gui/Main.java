...
public class Main extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2780364023957154559L;
	final static public SkeletonList SKELETONS = new SkeletonList(
			new java.io.File("skeletons"));
	final static public String VERSION = "@{VERSION}@";
	final static public String RELEASEINFO = "@{RELEASEINFO}@";

	final static public ResourceBundle TEXTS = PropertyResourceBundle
			.getBundle("locale.Texts");
	...
	private Main() {
		...
		m_projectFileChooser.addChoosableFileFilter(new SimpleFileFilter(
				"jsmooth", "JSmooth Project Files"));
	...
	private final Icon ICON_NEW = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_new.png"));
	public final Action NEW = new AbstractAction(local("NEW"), ICON_NEW) {
		/**
		 * 
		 */
		private static final long serialVersionUID = -5365477559214650932L;
	...
	private final Icon ICON_OPEN = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_open.png"));
	public final Action OPEN = new AbstractAction(local("OPEN"), ICON_OPEN) {
		/**
		 * 
		 */
		private static final long serialVersionUID = -7135272712356376115L;
	...
	private final Icon ICON_SAVE = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_save.png"));
	public final Action SAVE = new AbstractAction(local("SAVE"), ICON_SAVE) {
		/**
		 * 
		 */
		private static final long serialVersionUID = 6931604426473515498L;
	...
	private final Icon ICON_SAVE_AS = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_save_as.png"));
	public final Action SAVE_AS = new AbstractAction(local("SAVE_AS"),
			ICON_SAVE_AS) {
		/**
				 * 
				 */
				private static final long serialVersionUID = -716403915573443418L;

		public void actionPerformed(ActionEvent e) {
			if (m_projectFileChooser.showSaveDialog(Main.this) == JFileChooser.APPROVE_OPTION) {
				if ((m_panel.getModel() != null)
						&& (m_panel.getProjectFile() != null))
					m_panel.getModel().normalizePaths(
							m_panel.getProjectFile().getParentFile(), false);
	...
	private final Icon ICON_EXIT = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_exit-16.png"));
	public final Action EXIT = new AbstractAction(local("EXIT"), ICON_EXIT) {
		/**
		 * 
		 */
		private static final long serialVersionUID = -1125322943895015651L;
	...
	private final Icon ICON_COMPILE = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_autopilot-24.png"));
	public final Action COMPILE = new AbstractAction(local("COMPILE"),
			ICON_COMPILE) {
		/**
				 * 
				 */
				private static final long serialVersionUID = 8750315135631658407L;
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (compiler != null) {
				...
				dia.setNewState(100,
						"Error, compiler couldn't be created. Error description should follow:");
	...
	private final Icon ICON_RUNEXE = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_next.png"));
	public final Action RUNEXE = new AbstractAction(local("RUNEXE"),
			ICON_RUNEXE) {
		/**
				 * 
				 */
				private static final long serialVersionUID = 3010580188993707196L;
	...
	private final Icon ICON_ABOUT = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_about.png"));
	public final Action ABOUT = new AbstractAction(local("ABOUT"), ICON_ABOUT) {
		/**
		 * 
		 */
		private static final long serialVersionUID = 7018522987230812790L;
	...
	public void loadWindowSettings() {
		...
		if (prefs.getInt("window-x", -1) > 0) {
			this.setLocation(prefs.getInt("window-x", 10),
					prefs.getInt("window-y", 10));
		...
		if (args.length > 0) {
			...
			if (f.exists()) {
				...
				JOptionPane.showMessageDialog(null,
						Main.local("GENERAL_CANTOPENFILE"),
						Main.local("GENERAL_ERROR_LABEL"),

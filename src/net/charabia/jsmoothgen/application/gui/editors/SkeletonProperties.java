...
public class SkeletonProperties extends Editor implements
		JSmoothModelBean.SkeletonChangedListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6278204864085407923L;
	...
	protected String[] m_autourls = new String[] {
			...
			"JRE 1.3.1_08",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_1_08-windows-i586.cab",
			"JRE 1.3.1_07",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_1_07-windows-i586.cab",
			"JRE 1.3.1_06",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_1_06-windows-i586.cab",
			"JRE 1.3.1_05",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_1_05-windows-i586.cab",
			"JRE 1.3.1_04",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_1_04-win.cab",
			"JRE 1.3.1_03",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_1_03-win.cab",
			"JRE 1.3.1_02",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_1_02-win.cab",
			"JRE 1.3.1_01",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_1_01-win.cab",
			"JRE 1.3.0_05",
			"http://java.sun.com/products/plugin/autodl/jinstall-1_3_0_05-win.cab" };

	public class SkelEditorFactory implements
			...
			if (property instanceof SkeletonPropertyProxy) {
				...
				if (pname.equals("boolean"))
					...
					for (int i = 0; i < m_autourls.length; i += 2) {
						values[(i + 1) / 2] = new com.l2fprod.common.beans.editor.ComboBoxPropertyEditor.Value(
								m_autourls[i + 1], m_autourls[i]);
					}
	...
	public class SkeletonPropertyProxy extends DefaultProperty {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2341832410045081773L;
	...
	public void dataChanged() {
		System.out.println("SkeletonProperties: data changed, "
				+ m_model.getSkeletonName());

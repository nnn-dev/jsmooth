...
public class InitialMemoryHeap extends Editor {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1201484777832394513L;
	...
	public void updateModel() {
		...
		// System.out.println("sel index: " + m_units.getSelectedIndex() + " / "
		...
		// System.out.println("Resulting initmem: " +
		// m_model.getInitialMemoryHeap());
	}

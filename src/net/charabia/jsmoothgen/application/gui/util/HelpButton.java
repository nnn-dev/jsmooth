...
public class HelpButton extends JLabel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2628787220409194340L;

	protected JWindow m_helpWindow = new JWindow(Main.MAIN);

	private final Icon ICON_HELP = new javax.swing.ImageIcon(getClass()
			.getResource("/icons/stock_help-agent-16.png"));
	...
	public HelpButton(String helptext) {
		...
		jep.setBorder(javax.swing.BorderFactory

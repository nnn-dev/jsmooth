...
/**
 * Represents a JTextField associated with a button that pops up a file dialog
 * selector.
 * 
 */
...
public class OptionalHelpPanel extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4998577209530832853L;
	...
	private HTMLPane m_helpPanel = new HTMLPane() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5838049760511283569L;
	...
	public OptionalHelpPanel() {
		...
		java.net.URL helpimgurl = getClass().getResource(
				"/icons/stock_help-agent.png");
		if (helpimgurl != null) {
	...
	public static void main(String[] args) {
		...
		// ohp.getContentPane().add(BorderLayout.CENTER, new JScrollPane(new
		// JTextArea(40,40)));
		ohp.getContentPane().add(BorderLayout.CENTER,
				new FileSelectionTextField());

...
public class FileSelectionTextField extends javax.swing.JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5171338474921474011L;
	...
	private void buttonFileSelectionActionPerformed(
		...
		if (m_fileChooser.showDialog(this, "Select") == JFileChooser.APPROVE_OPTION) {
			...
			if (m_basedir != null) {
				File rel = net.charabia.jsmoothgen.application.JSmoothModelPersistency
						.makePathRelativeIfPossible(m_basedir, f);

...
public class HTMLPane extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1736559547619193950L;
				...
				if (e instanceof HTMLFrameHyperlinkEvent) {
					...
					try {
						...
						if (jsmooth.Native.isAvailable()) {
							jsmooth.Native.shellExecute(
									jsmooth.Native.SHELLEXECUTE_OPEN,
									nurl.toString(), null, null,
	...
	public HTMLPane() {
		...
		m_html = new JEditorPane("text/html", "<html></html>") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -7884780714640620591L;

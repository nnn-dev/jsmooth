...
public class ClassChooserDialog extends javax.swing.JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7350456273597777269L;
	...
	public class ClassTreeListener implements TreeSelectionListener {
		public void valueChanged(TreeSelectionEvent e) {
			...
			JarEntryTreeNode last = (JarEntryTreeNode) tp
	...
	public class JarEntryTreeNode extends
			javax.swing.tree.DefaultMutableTreeNode {
		/**
		 * 
		 */
		private static final long serialVersionUID = -8630845372706340453L;

		public JarEntryTreeNode(String value) {
			super(value);
			DefaultTreeCellRenderer renderer = new DefaultTreeCellRenderer();
			java.net.URL imgurl = getClass().getResource(
					"/icons/stock_form-autopilots-16.png");
			if (imgurl != null) {
	...
	public void addJar(JarFile jf) {
		for (Enumeration e = jf.entries(); e.hasMoreElements();) {
			...
			if ((res.length > 0)
					&& (res[res.length - 1].toLowerCase().endsWith(".class"))) {
	...
	public String getClassName() {
		...
		for (int i = 1; i < objs.length; i++) {
			if (i > 1)
				cname.append(".");
			cname.append(((JarEntryTreeNode) objs[i]).getUserObject()
					.toString());
		}
	...
	private void initComponents()// GEN-BEGIN:initComponents
	{
		...
		m_buttonSelect.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/icons/stock_calc-accept-16.png")));
		...
		m_buttonCancel.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/icons/stock_calc-cancel-16.png")));
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 371) / 2, (screenSize.height - 260) / 2,
				371, 260);

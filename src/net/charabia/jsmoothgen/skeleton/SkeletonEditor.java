...
public class SkeletonEditor extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4119849078360458308L;
	...
	private void initComponents()// GEN-BEGIN:initComponents
	{
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 400) / 2, (screenSize.height - 254) / 2,
				400, 254);
	...
	{// GEN-HEADEREND:event_menuLoadKBMLActionPerformed
		...
		if (m_fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
			...
			System.out.println("loading "
					+ m_fileChooser.getSelectedFile().toString());
			try {

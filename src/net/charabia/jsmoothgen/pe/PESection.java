...
public class PESection implements Cloneable {
	...
	long VirtualSize; // The size of the section when it is mapped to memory.
						// Must be a multiple of 4096. (8)(DWORD)
	long VirtualAddress; // An rva to where it should be mapped in memory.
							// (12)(DWORD)
	long SizeOfRawData; // The size of the section in the PE file. Must be a
						// multiple of 512 (16)(DWORD)
	long PointerToRawData; // A file based offset which points to the location
							// of this sections data (20)(DWORD)
	long PointerToRelocations; // In EXE's this field is meaningless, and is set
								// 0 (24)(DWORD)
	long PointerToLinenumbers; // This is the file-based offset of the line
								// number table. This field is only used for
								// debug purposes, and is usualy set to 0
								// (28)(DWORD)
	int NumberOfRelocations; // In EXE's this field is meaningless, and is set 0
								// (32)(WORD)
	int NumberOfLinenumbers; // The number of line numbers in the line number
								// table for this section. This field is only
								// used for debug purposes, and is usualy set to
								// 0 (34)(WORD)
	long Characteristics; // The kind of data stored in this section ie. Code,
							// Data, Import data, Relocation data (36)(DWORD)
	...
	public void dump(PrintStream out) {
		...
		out.println("  NumberOfRelocations= "
				+ NumberOfRelocations
				+ "   // 	In EXE's this field is meaningless, and is set 0 (32)(WORD)");
		out.println("  NumberOfLinenumbers= "
				+ NumberOfLinenumbers

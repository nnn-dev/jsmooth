...
public class ResIcon {
	...
	public ResIcon(ByteBuffer in) {
		...
		// int xorbytes = (((int)Height/2) * (int)Width * (int)BitsPerPixel) /
		// 8;
		int xorbytes = (((int) Height / 2) * (int) Width);
		// System.out.println("POSITION " + in.position() + " : xorbitmap = " +
		// xorbytes + " bytes");
		...
		// System.out.println("POSITION " + in.position() + " : andbitmap = " +
		// andbytes + " bytes");
	...
	public ResIcon(Image img) throws Exception {
		...
		// System.out.println("FOUND WIDTH " + width + " (was " +
		// img.getWidth(null) + ")");
		// System.out.println("FOUND HEIGHT " + height + " (was " +
		// img.getHeight(null) + ")");
		...
		// System.out.println("Creating palette of " + Palette.length +
		// " colors (" + colors.size() + ")");
	...
	public ByteBuffer getData() {
		...
		ByteBuffer buf = ByteBuffer
				.allocate((int) (40 + (cols * 4)
						+ (Width * (Height / 2) * BitsPerPixel) / 8 + (rowsize * (Height / 2))));
		...
		// System.out.println("GET DATA :: Palette.size= "+Palette.length +
		...
		case 8: {
			// System.out.println("GET DATA :: XORBitmap.size= "+BitmapXOR.length
			// + " // position=" + buf.position());
			for (int i = 0; i < BitmapXOR.length; i++) {
		...
		// System.out.println("GET DATA :: AndBitmap.size= "+BitmapAND.length +
		// " // position=" + buf.position());
		for (int i = 0; i < BitmapAND.length; i++) {
